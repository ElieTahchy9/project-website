...
<div className="my-4">
    ...
    <h1>Available locations : </h1>
      ...
      <Link to="https://www.tripadvisor.com/Attraction_Review-g3861905-d12537408-Reviews-Rafting_Squad-Hermel_Bekaa_Governorate.html" target="_blank" rel="noopener noreferrer">
        <Card.Img variant="top" src={'http://localhost:5000/Images/ActivityQoubayatRafting.jpg'} />   
        </Link>
        <Card.Body>
...
export default SecondActivityQoubayat; 
