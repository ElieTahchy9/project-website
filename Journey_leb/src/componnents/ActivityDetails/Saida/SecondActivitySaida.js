...
try {
    const response = await fetch('http://localhost:5000/api/city/8/activity-details'); // Replace 'your_city_id' with the actual city ID
...
<div className="my-4">
    ...
    <div>
      ...
      <Card style={{ width: '18rem' }}>
        <Card.Img variant="top" src={'http://localhost:5000/Images/SaidaAct2.jpg'} />
        <Card.Body>
...
export default SecondActivitySaida; 
