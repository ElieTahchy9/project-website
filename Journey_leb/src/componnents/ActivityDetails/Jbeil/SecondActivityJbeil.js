...
try {
    const response = await fetch('http://localhost:5000/api/city/6/activity-details'); // Replace 'your_city_id' with the actual city ID
...
<div className="my-4">
    ...
    <h1>Available locations : </h1>
      ...
      <Link to="https://beachsearcher.com/en/beach/422201015/bahsa-beach" target="_blank" rel="noopener noreferrer">
        <Card.Img variant="top" src={'http://localhost:5000/Images/ActivityJbeilSwimming.jpg'} /> 
        </Link>
        <Card.Body>
...
export default SecondActivityJbeil; 
