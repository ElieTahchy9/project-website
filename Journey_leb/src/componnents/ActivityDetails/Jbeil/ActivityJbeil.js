...
<div className="my-4">
    ...
    <h1>Available locations : </h1>
      ...
      <Link to="https://www.bikemap.net/en/r/11196167/" target="_blank" rel="noopener noreferrer">
        <Card.Img variant="top" src={'http://localhost:5000/Images/ActivityJbeilCycling.jpg'} /> 
        </Link>
        <Card.Body>
